...
var app = new _vue2.default({
    ...
    methods: {
        ...
        projectsSaveOrUpdate: function projectsSaveOrUpdate() {
        ...
        signUp: function signUp() {
            var self = this;
            var user = new _leancloudStorage2.default.User(); // 新建 AVUser 对象实例
        ...
        signIn: function signIn() {
            var self = this;
            _leancloudStorage2.default.User.logIn(this.signInData.username, this.signInData.password).then(function (loginedUser) {
                self.currentUser = self.getCurrentUser();
                self.fetchTasks();
            }, function (error) {
                console.log(error);
        ...
        getCurrentUser: function getCurrentUser() {
            var curUser = _leancloudStorage2.default.User.current();
            if (curUser) {
                var id = curUser.id,
                    createdAt = curUser.createdAt,
                    username = curUser.attributes.username;
        ...
        signOut: function signOut() {
            _leancloudStorage2.default.User.logOut(); // 现在的 currentUser 是 null 了
            this.currentUser = _leancloudStorage2.default.User.current(); // 赋值null过去
        ...
        checkoutTask: function checkoutTask(item, index) {
        ...
        cancleEdit: function cancleEdit(item) {
